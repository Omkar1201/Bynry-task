    ...
    <div className="container mx-auto my-10 p-5 bg-white rounded-lg shadow-lg -[40rem]">
      ...
      <div className="mt-6">
        ...
        <div className="text-gray-600">
          ...
          <p className="text-md text-gray-500 mb-2"><strong>Interests:</strong> {profile.interests}</p> {/* Display interests */}
          <p className="text-md text-gray-500 mb-2"><strong>Job:</strong> {profile.job}</p> {/* Display interests */}
